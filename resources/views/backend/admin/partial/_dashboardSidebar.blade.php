...
<<<<<<< HEAD
            ...
            <div class="side-menu-wrap">
                <ul class="side-menu-ul">
                    ...
                    <li class="sidenav__item"><a class="text-center" href="{{ route('quiz.index') }}"><i
                                class="la la-bolt"></i>
                    ...
                    <li class="sidenav__item"><a class="text-center" href="/dashboard-message"><i
                                class="la la-bell"></i>
                            <p class="w-100">پیام ها</p> <span class="badge badge-info radius-rounded p-1 ml-1">2</span>
                        </a>
                    </li>
                    <li class="sidenav__item"><a class="text-center" href="/dashboard-reviews"><i
                                class="la la-star"></i>
...
>>>>>>> 5aa2a72274b0cdcd3e087f80fb16d718a591be19
        @endcan
        @can('Teacher')
