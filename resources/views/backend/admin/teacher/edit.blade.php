...
@section('main.content')
    <section dir="rtl">
        ...
        <section class="container" style="padding: 50px" dir="rtl">
            ...
            {{ Form::model($teacher,['route' => ['teacher.update',$teacher->id], 'method' => 'put','files'=>true])}}
            ...
            <section class="form-group">
                <a href="{{route('teacher.index')}}"><input type="button" class="form-control btn btn-success"
