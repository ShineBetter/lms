(function ($) {
    ...
    $(document).ready(function () {
        ...
        var dropdowmMenu = $('.main-menu .dropdown-menu-item, .sub-menu');
        ...
        var dropMenuToggler = $('.main-menu .sub-nav-toggler, .sub-nav-toggler');
        ...
        $('.faq-body > .faq-panel').on('click', function () {
            $(this).siblings('.faq-panel').removeClass('is-active').children('.faq-content').slideUp(500);
