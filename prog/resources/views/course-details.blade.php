            ...
            <div class="col-lg-12">
                <div class="breadcrumb-content breadcrumb-detail-content">
                    <div class="section-heading">
                        ...
                        <h2 class="section__title mt-1">The Complete Digital Finance Marketing Course</h2>
                        <h4 class="widget-title mt-2">Master Digital Marketing: Strategy, Social Media Marketing, SEO, YouTube, Email, Facebook Marketing, Analytics & More!</h4>
                    </div>
                ...
                <div class="course-detail-content-wrap margin-top-100px">
                    <div class="post-overview-card margin-bottom-50px">
                        ...
                        <ul class="list-items mt-3">
                            <li><i class="la la-check-circle"></i> Proven Tips and Tricks of the Digital Marketing Trade</li>
                            <li><i class="la la-check-circle"></i> Growth Hacking</li>
                            <li><i class="la la-check-circle"></i> Unique Ways of Promoting a Business from Scratch</li>
                            <li><i class="la la-check-circle"></i> Inbound Marketing</li>
                            <li><i class="la la-check-circle"></i> How to Generate More Traffic and Leads for Your Brand</li>
                            <li><i class="la la-check-circle"></i> Marketing Strategy</li>
                            <li><i class="la la-check-circle"></i> Digital Marketing Tools and Strategies</li>
                            <li><i class="la la-check-circle"></i> Income Statements</li>
                        </ul>
                    ...
                    <div class="description-wrap margin-bottom-40px">
                        ...
                        <h5 class="font-size-16 ">Why should you consider a career as a Financial Analyst?</h5>
                        <ul class="list-items mt-2 mb-3">
                            <li>Salary. A Financial Analyst job usually leads to a very well-paid career</li>
                            <li>Promotions. Financial Analysts acquire valuable technical skills</li>
                            <li>Secure Future. There is high demand for Financial Analysts on the job market</li>
                            <li>Growth. This isn’t a boring job. Every day, you will face different challenges</li>
                        </ul>
                        <h5 class="font-size-16 line-height-27 ">Just go ahead and subscribe to this course! If you don't acquire these skills now, you will miss an opportunity to separate yourself from the others. Don't risk your future success! Let's start learning together now!</h5>
                    ...
                    <div class="curriculum-wrap margin-bottom-60px">
                        <div class="curriculum-header d-flex align-items-center justify-content-between">
                            ...
                            <div class="curriculum-header-right">
                                <span class="curriculum-total__text"><strong>Total:</strong> 17 lectures</span>
                            ...
                            <div class="accordion accordion-shared" id="accordionExample">
                                            ...
                                            <ul class="list-items">
                                                <li>
                                                    <a href="javascript:void(0)" class="primary-color-2 d-flex align-items-center justify-content-between" data-toggle="modal" data-target=".preview-modal-form">
                                                        <span><i class="fa fa-play-circle mr-2"></i>Introductory words <span class="badge-label">Preview</span></span>
                                                        <span class="course-duration">03:07</span>
                                                    </a>
                                                </li>
                                                <li>
                                                    <a href="javascript:void(0)" class="primary-color-2 d-flex align-items-center justify-content-between" data-toggle="modal" data-target=".preview-modal-form">
                                                        <span><i class="fa fa-play-circle mr-2"></i>General Marketing Part 1 <span class="badge-label">Preview</span></span>
                                                        <span class="course-duration">08:02</span>
                                                    </a>
                                                </li>
                                                <li>
                                                    <a href="javascript:void(0)" class="d-flex align-items-center justify-content-between">
                                                        <span><i class="fa fa-play-circle mr-2"></i>General Marketing Part 2 <span class="badge-label badge-secondary">Locked</span></span>
                                                        <span class="course-duration">03:02</span>
                                                    </a>
                                                </li>
                                                <li>
                                                    <a href="javascript:void(0)" class="d-flex align-items-center justify-content-between">
                                                        <span><i class="fa fa-play-circle mr-2"></i>General Marketing Part 3 <span class="badge-label badge-secondary">Locked</span></span>
                                                        <span class="course-duration">15:02</span>
                                                    </a>
                                                </li>
                                                <li>
                                                    <a href="javascript:void(0)" class="d-flex align-items-center justify-content-between">
                                                        <span><i class="fa fa-play-circle mr-2"></i>General Marketing Part 4 <span class="badge-label badge-secondary">Locked</span></span>
                                                        <span class="course-duration">10:02</span>
                                                    </a>
                                                </li>
                                                <li>
                                                    <a href="javascript:void(0)" class="d-flex align-items-center justify-content-between">
                                ...
                                <div class="card">
                                    <div class="card-header" id="headingTwo">
                                        <h2 class="mb-0">
                                            <button class="btn btn-link collapsed d-flex align-items-center justify-content-between" type="button" data-toggle="collapse" data-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
                                                <i class="fa fa-angle-up"></i>
                                                <i class="fa fa-angle-down"></i>
                                    ...
                                    <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionExample">
                                        <div class="card-body">
                                            <ul class="list-items">
                                                <li>
                                                    <a href="javascript:void(0)" class="d-flex align-items-center justify-content-between">
                                                        <span><i class="fa fa-play-circle mr-2"></i>Microsoft Excel: The World's #1 Office Software<span class="badge-label badge-secondary">Locked</span></span>
                                                        <span class="course-duration">22:42</span>
                                                    </a>
                                                </li>
                                                <li>
                                                    <a href="javascript:void(0)" class="d-flex align-items-center justify-content-between">
                                                        <span><i class="fa fa-play-circle mr-2"></i>Excel Made Easy: A Beginner's Guide to Excel Spreadsheets <span class="badge-label badge-secondary">Locked</span></span>
                                                        <span class="course-duration">22:42</span>
                                                    </a>
                                                </li>
                                                <li>
                                                    <a href="javascript:void(0)" class="d-flex align-items-center justify-content-between">
                                                        <span><i class="fa fa-bolt mr-2"></i>Inserting, Deleting, and Modifying Rows & Columns</span>
                                                        <span class="course-duration">1 question</span>
                                                    </a>
                                                </li>
                                            </ul>
                                ...
                                <div class="card">
                                    <div class="card-header" id="headingThree">
                                        <h2 class="mb-0">
                                            <button class="btn btn-link collapsed d-flex align-items-center justify-content-between" type="button" data-toggle="collapse" data-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree">
                                                <i class="fa fa-angle-up"></i>
                                                <i class="fa fa-angle-down"></i>
                                                Content Marketing
                                                <span>1 lecture</span>
                                    ...
                                    <div id="collapseThree" class="collapse" aria-labelledby="headingThree" data-parent="#accordionExample">
                                        <div class="card-body">
                                            <ul class="list-items">
                                                <li>
                                                    <a href="javascript:void(0)" class="d-flex align-items-center justify-content-between">
                                                        <span>Content Marketing <span class="badge-label badge-secondary">Locked</span></span>
                                                        <span class="course-duration">19:02</span>
                                                    </a>
                                                </li>
                                            </ul>
                                        </div><!-- end card-body -->
                                ...
                                <div class="card">
                                    <div class="card-header" id="headingFour">
                                        <h2 class="mb-0">
                                            <button class="btn btn-link collapsed d-flex align-items-center justify-content-between" type="button" data-toggle="collapse" data-target="#collapseFour" aria-expanded="false" aria-controls="collapseFour">
                                                <i class="fa fa-angle-up"></i>
                                                <i class="fa fa-angle-down"></i>
                                                Mobile Marketing
                                                <span>1 lecture</span>
                                    ...
                                    <div id="collapseFour" class="collapse" aria-labelledby="headingFour" data-parent="#accordionExample">
                                        <div class="card-body">
                                            <ul class="list-items">
                                                <li>
                                                    <a href="javascript:void(0)" class="d-flex align-items-center justify-content-between">
                                                        <span> Mobile Marketing <span class="badge-label badge-secondary">Locked</span></span>
                                                        <span class="course-duration">5:02</span>
                                                    </a>
                                                </li>
                                            </ul>
                                        </div><!-- end card-body -->
                                ...
                                <div class="card">
                                    <div class="card-header" id="headingFive">
                                        <h2 class="mb-0">
                                            <button class="btn btn-link collapsed d-flex align-items-center justify-content-between" type="button" data-toggle="collapse" data-target="#collapseFive" aria-expanded="false" aria-controls="collapseFive">
                                                <i class="fa fa-angle-up"></i>
                                                <i class="fa fa-angle-down"></i>
                                                PPC
                                                <span>1 lecture</span>
                                    ...
                                    <div id="collapseFive" class="collapse" aria-labelledby="headingFive" data-parent="#accordionExample">
                                        <div class="card-body">
                                            <ul class="list-items">
                                                <li>
                                                    <a href="javascript:void(0)" class="d-flex align-items-center justify-content-between">
                                                        <span> PPC <span class="badge-label badge-secondary">Locked</span></span>
                                                        <span class="course-duration">7:02</span>
                                                    </a>
                                                </li>
                                            </ul>
                                        </div><!-- end card-body -->
                                ...
                                <div class="card">
                                    <div class="card-header" id="headingSix">
                                        <h2 class="mb-0">
                                            <button class="btn btn-link collapsed d-flex align-items-center justify-content-between" type="button" data-toggle="collapse" data-target="#collapseSix" aria-expanded="false" aria-controls="collapseSix">
                                                <i class="fa fa-angle-up"></i>
                                                <i class="fa fa-angle-down"></i>
                                                SEO
                                    ...
                                    <div id="collapseSix" class="collapse" aria-labelledby="headingSix" data-parent="#accordionExample">
                                        <div class="card-body">
                                            <ul class="list-items">
                                                <li>
                                                    <a href="javascript:void(0)" class="d-flex align-items-center justify-content-between">
                                                        <span> SEO Part 1 <span class="badge-label badge-secondary">Locked</span></span>
                                                        <span class="course-duration">7:02</span>
                                                    </a>
                                                </li>
                                                <li>
                                                    <a href="javascript:void(0)" class="d-flex align-items-center justify-content-between">
                                                        <span> SEO Part 2 <span class="badge-label badge-secondary">Locked</span></span>
                                                        <span class="course-duration">3:02</span>
                                                    </a>
                                                </li>
                                            </ul>
                                        </div><!-- end card-body -->
                                ...
                                <div class="card">
                                    <div class="card-header" id="headingSeven">
                                        <h2 class="mb-0">
                                            <button class="btn btn-link collapsed d-flex align-items-center justify-content-between" type="button" data-toggle="collapse" data-target="#collapseSeven" aria-expanded="false" aria-controls="collapseSeven">
                                                <i class="fa fa-angle-up"></i>
                                                <i class="fa fa-angle-down"></i>
                                                Video Marketing
                                                <span>1 lecture</span>
                                    ...
                                    <div id="collapseSeven" class="collapse" aria-labelledby="headingSeven" data-parent="#accordionExample">
                                        <div class="card-body">
                                            <ul class="list-items">
                                                <li>
                                                    <a href="javascript:void(0)" class="d-flex align-items-center justify-content-between">
                                                        <span> Video Marketing <span class="badge-label badge-secondary">Locked</span></span>
                                                        <span class="course-duration">6:02</span>
                                                    </a>
                                                </li>
                                            </ul>
                                        </div><!-- end card-body -->
                                ...
                                <div class="card">
                                    <div class="card-header" id="headingEight">
                                        <h2 class="mb-0">
                                            <button class="btn btn-link collapsed d-flex align-items-center justify-content-between" type="button" data-toggle="collapse" data-target="#collapseEight" aria-expanded="false" aria-controls="collapseEight">
                                                <i class="fa fa-angle-up"></i>
                                                <i class="fa fa-angle-down"></i>
                                                Customer Management
                                                <span>1 lecture</span>
                                    ...
                                    <div id="collapseEight" class="collapse" aria-labelledby="headingEight" data-parent="#accordionExample">
                                        <div class="card-body">
                                            <ul class="list-items">
                                                <li>
                                                    <a href="javascript:void(0)" class="d-flex align-items-center justify-content-between">
                                                        <span> Custom Management <span class="badge-label badge-secondary">Locked</span></span>
                                                        <span class="course-duration">6:02</span>
                                                    </a>
                                                </li>
                                            </ul>
                                ...
                                <div class="card">
                                    <div class="card-header" id="headingNine">
                                        <h2 class="mb-0">
                                            <button class="btn btn-link collapsed d-flex align-items-center justify-content-between" type="button" data-toggle="collapse" data-target="#collapseNine" aria-expanded="false" aria-controls="collapseNine">
                                                <i class="fa fa-angle-up"></i>
                                                <i class="fa fa-angle-down"></i>
                                    ...
                                    <div id="collapseNine" class="collapse" aria-labelledby="headingNine"
                                        ...
                                        <div class="card-body">
                                            <ul class="list-items">
                                                <li>
                                                    <a href="javascript:void(0)" class="d-flex align-items-center justify-content-between">
                                                        <span> Social Media Part 1<span class="badge-label badge-secondary">Locked</span></span>
                                                        <span class="course-duration">5:02</span>
                                                    </a>
                                                </li>
                                                <li>
                                                    <a href="javascript:void(0)" class="d-flex align-items-center justify-content-between">
                                                        <span> Social Media Part 2<span class="badge-label badge-secondary">Locked</span></span>
                                                        <span class="course-duration">3:02</span>
                                                    </a>
                                                </li>
                                                <li>
                                                    <a href="javascript:void(0)" class="d-flex align-items-center justify-content-between">
                                                        <span> Social Media Part 3<span class="badge-label badge-secondary">Locked</span></span>
                                                        <span class="course-duration">5:02</span>
                                                    </a>
                                                </li>
                                            </ul>
                                ...
                                <div class="card">
                                    <div class="card-header" id="headingTen">
                                        <h2 class="mb-0">
                                            <button class="btn btn-link collapsed d-flex align-items-center justify-content-between" type="button" data-toggle="collapse" data-target="#collapseTen" aria-expanded="false" aria-controls="collapseTen">
                                                <i class="fa fa-angle-up"></i>
                                                <i class="fa fa-angle-down"></i>
                                                Conclusion
                                                <span>1 lecture</span>
                                    ...
                                    <div id="collapseTen" class="collapse" aria-labelledby="headingTen" data-parent="#accordionExample">
                                        <div class="card-body">
                                            <ul class="list-items">
                                                <li>
                                                    <a href="javascript:void(0)" class="primary-color-2 d-flex align-items-center justify-content-between" data-toggle="modal" data-target=".preview-modal-form">
                                                        <span>Conclusion<span class="badge-label">Watch</span></span>
                                                        <span class="course-duration">05:07</span>
                                                    </a>
                                                </li>
                                            </ul>
                                        </div><!-- end card-body -->
                    ...
                    <div class="view-more-courses mt-5">
                        <h3 class="widget-title">Students also bought</h3>
                    ...
                    <div class="report-modal-box">
                        <button type="button" class="theme-btn theme-btn-light" data-toggle="modal" data-target=".report-modal-form">
                            <i class="la la-flag font-size-18 mr-1"></i>Report abuse
                        </button>
                    </div>
                ...
                <div class="sidebar-component">
                    <div class="sidebar">
                            ...
                            <div class="preview-video-and-details">
                                ...
                                <div class="preview-course-content">
                                    ...
                                    <div class="buy-course-btn mb-3 text-center">
                                        <a href="course-details.blade.php#" class="theme-btn w-100 mb-3">buy this course</a>
                                        <a href="lesson-details.html" class="theme-btn w-100 theme-btn-light">go to course</a>
                                    </div>
                        ...
                        <div class="sidebar-widget category-widget">
                            ...
                            <span class="section-divider"></span>
                            <ul class="list-items">
                                <li><a href="course-details.blade.php#">Web design</a></li>
                                <li><a href="course-details.blade.php#">Development</a></li>
                                <li><a href="course-details.blade.php#">fron-end</a></li>
                                <li><a href="course-details.blade.php#">photography</a></li>
                                <li><a href="course-details.blade.php#">technology</a></li>
                                <li><a href="course-details.blade.php#">IT & Software</a></li>
                                <li><a href="course-details.blade.php#">backend</a></li>
                                <li><a href="course-details.blade.php#">marketing</a></li>
                            </ul>
                        </div><!-- end sidebar-widget -->
                        <div class="sidebar-widget recent-widget">
                            ...
                            <div class="recent-item">
                                ...
                                <div class="recentpost-body">
                                    <span class="recent__meta"> 12 Jan, 2019 by <a href="course-details.blade.php#">Jhon Deo</a></span>
                                    <h4 class="recent__link">
                                        <a href="course-details.blade.php">Become a PHP Master and Make Money</a>
                                    </h4>
                            ...
                            <div class="recent-item">
                                ...
                                <div class="recentpost-body">
                                    <span class="recent__meta"> 14 Jan, 2019 by <a href="course-details.blade.php#">Alex Smith</a></span>
                                    <h4 class="recent__link">
                                        <a href="course-details.blade.php">Learning jQuery Mobile for Beginners</a>
                                    </h4>
                                    <p class="recent-course__price">$35.00<span>$70.99</span></p>
                                </div><!-- end recent-img -->
                            </div><!-- end recent-item -->
                            <div class="recent-item">
                                <div class="recent-img">
                                ...
                                <div class="recentpost-body">
                                    <span class="recent__meta"> 15 Jan, 2019 by <a href="course-details.blade.php#">Mark Doe</a></span>
                                    <h4 class="recent__link">
                                        <a href="course-details.blade.php">Introduction LearnPress – LMS plugin</a>
                                    </h4>
                                    <p class="recent-course__price">Free</p>
                                </div><!-- end recent-img -->
                            </div><!-- end recent-item -->
                            <div class="btn-box text-center">
                                <a href="course-grid.html" class="theme-btn d-block">view all courses</a>
                            </div><!-- end btn-box -->
                        </div><!-- end sidebar-widget -->
                        <div class="sidebar-widget tag-widget">
                            ...
                            <span class="section-divider"></span>
                            <ul class="list-items">
                                <li><a href="course-details.blade.php#">beginner</a></li>
                                <li><a href="course-details.blade.php#">advanced</a></li>
                                <li><a href="course-details.blade.php#">tips</a></li>
                                <li><a href="course-details.blade.php#">photoshop</a></li>
                                <li><a href="course-details.blade.php#">software</a></li>
                                <li><a href="course-details.blade.php#">backend</a></li>
                                <li><a href="course-details.blade.php#">freelance</a></li>
                                <li><a href="course-details.blade.php#">technology</a></li>
                            </ul>
                        </div><!-- end sidebar-widget -->
                    </div><!-- end sidebar -->
                ...
                <div class="modal-top">
                    <div>
                        ...
                        <p class="mt-2 font-size-15 line-height-26">
                            ...
                            If you have a question or technical issue, please contact our <a href="course-details.blade.php#" class="primary-color-2">Support team here</a>.
                        </p>
                    </div>
                    <button type="button" class="close close-arrow" data-dismiss="modal" aria-label="Close">
            ...
            <div class="modal-content">
                ...
                <div class="copy-to-clipboard-wrap p-4 text-center">
                    ...
                    <ul class="social-profile">
                        <li><a href="course-details.blade.php#"><i class="fa fa-facebook"></i></a></li>
                        <li><a href="course-details.blade.php#"><i class="fa fa-twitter"></i></a></li>
                        <li><a href="course-details.blade.php#"><i class="fa fa-instagram"></i></a></li>
                        <li><a href="course-details.blade.php#"><i class="fa fa-linkedin"></i></a></li>
                    </ul>
                </div>
            </div><!-- end modal-content -->
        </div><!-- end modal-dialog -->
