                ...
                <div class="col-lg-5">
                    <div class="section-heading">
                        ...
                        <ul class="social-profile">
                            <li><a href="contact.blade.php#"><i class="fa fa-facebook"></i></a></li>
                            <li><a href="contact.blade.php#"><i class="fa fa-twitter"></i></a></li>
                            <li><a href="contact.blade.php#"><i class="fa fa-instagram"></i></a></li>
                            <li><a href="contact.blade.php#"><i class="fa fa-youtube-play"></i></a></li>
                        </ul>
