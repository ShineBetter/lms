...
{{--            {{$i=0}}--}}
            @foreach($admin as $item)
                ...
                <tr style="text-align: justify">
                    ...
                    <td style="text-align: center"><a href="{{route('admin.edit',$item->id)}}"><input type="button" class="btn btn-info" style="font-size: 15px;font-family: Tahoma" value="ویرایش"></a></td>
        ...
        <section class="form-group">
            <td style="text-align: center"><a href="{{route('admin.create')}}"><input type="button" class="form-control btn btn-info"  style="font-size: 15px;font-family: Tahoma"value="صفحه درج "></a></td>
        </section>
