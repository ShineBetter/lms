                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-12 col-sm-12">
                                            <div class="input-box">
                                                <div class="student_radio_inputs_group">
                                                    <input type="radio" class="student_radio_input" {{$data->product_count == -1 ? 'checked' : ''}}
                                        ...
                                        <div class="col-lg-6 col-sm-6 d-flex align-items-center">
                                            <div class="input-box">
                                                ...
                                                <span class="primary-color-2 ml-1">*</span>
                                                <input type="checkbox" name="product_status" value="0" id="checked" class="cbx hidden" {{$data->product_status == 1 ? 'checked' : ''}}/>
