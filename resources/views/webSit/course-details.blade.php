                                            ...
                                            <ul class="list-items">
                                                <li>
                                                    <a href="javascript:void(0)" class="primary-color-2 d-flex align-items-center justify-content-between" data-toggle="modal" data-target=".preview-modal-form">
                                                        <span><i class="fas fa-play-circle mr-2"></i>Introductory words <span class="badge-label">Preview</span></span>
                                                        <span class="course-duration">03:07</span>
                                                    </a>
                                                </li>
                                                <li>
                                                    <a href="javascript:void(0)" class="primary-color-2 d-flex align-items-center justify-content-between" data-toggle="modal" data-target=".preview-modal-form">
                                                        <span><i class="fas fa-play-circle mr-2"></i>General Marketing Part 1 <span class="badge-label">Preview</span></span>
                                                        <span class="course-duration">08:02</span>
                                                    </a>
                                                </li>
                                                <li>
                                                    <a href="javascript:void(0)" class="d-flex align-items-center justify-content-between">
                                                        <span><i class="fas fa-play-circle mr-2"></i>General Marketing Part 2 <span class="badge-label badge-secondary">Locked</span></span>
                                                        <span class="course-duration">03:02</span>
                                                    </a>
                                                </li>
                                                <li>
                                                    <a href="javascript:void(0)" class="d-flex align-items-center justify-content-between">
                                                        <span><i class="fas fa-play-circle mr-2"></i>General Marketing Part 3 <span class="badge-label badge-secondary">Locked</span></span>
                                                        <span class="course-duration">15:02</span>
                                                    </a>
                                                </li>
                                                <li>
                                                    <a href="javascript:void(0)" class="d-flex align-items-center justify-content-between">
                                                        <span><i class="fas fa-play-circle mr-2"></i>General Marketing Part 4 <span class="badge-label badge-secondary">Locked</span></span>
                                                        <span class="course-duration">10:02</span>
                                                    </a>
                                                </li>
                                                <li>
                                                    <a href="javascript:void(0)" class="d-flex align-items-center justify-content-between">
                                                        <span><i class="fas fa-file mr-2"></i>Download All Course Materials and FAQ</span>
                                                        <span class="course-duration">2:02</span>
                                                    </a>
                                                </li>
                                                <li>
                                                    <a href="javascript:void(0)" class="d-flex align-items-center justify-content-between">
                                                        <span><i class="fas fa-bolt mr-2"></i>Data Entry Techniques in Excel</span>
                                    ...
                                    <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionExample">
                                        <div class="card-body">
                                            <ul class="list-items">
                                                <li>
                                                    <a href="javascript:void(0)" class="d-flex align-items-center justify-content-between">
                                                        <span><i class="fas fa-play-circle mr-2"></i>Microsoft Excel: The World's #1 Office Software<span class="badge-label badge-secondary">Locked</span></span>
                                                        <span class="course-duration">22:42</span>
                                                    </a>
                                                </li>
                                                <li>
                                                    <a href="javascript:void(0)" class="d-flex align-items-center justify-content-between">
                                                        <span><i class="fas fa-play-circle mr-2"></i>Excel Made Easy: A Beginner's Guide to Excel Spreadsheets <span class="badge-label badge-secondary">Locked</span></span>
                                                        <span class="course-duration">22:42</span>
                                                    </a>
                                                </li>
                                                <li>
                                                    <a href="javascript:void(0)" class="d-flex align-items-center justify-content-between">
                                                        <span><i class="fas fa-bolt mr-2"></i>Inserting, Deleting, and Modifying Rows & Columns</span>
                                                        <span class="course-duration">1 question</span>
                                                    </a>
                                                </li>
                                            </ul>
            ...
            <div class="modal-content">
                ...
                <div class="copy-to-clipboard-wrap p-4 text-center">
                    ...
                    <ul class="social-profile">
                        <li><a href="course-details.blade.php#"><i class="fas fa-facebook"></i></a></li>
                        <li><a href="course-details.blade.php#"><i class="fas fa-twitter"></i></a></li>
                        <li><a href="course-details.blade.php#"><i class="fas fa-instagram"></i></a></li>
                        <li><a href="course-details.blade.php#"><i class="fas fa-linkedin"></i></a></li>
                    </ul>
                </div>
            </div><!-- end modal-content -->
        </div><!-- end modal-dialog -->
