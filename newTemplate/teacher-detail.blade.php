            ...
            <div class="col-lg-12">
                <div class="breadcrumb-content instructor-bread-content d-flex align-items-center">
                    ...
                    <div class="section-heading">
                        <h2 class="section__title font-size-30">فلک دین</h2>
                        <p class="section__desc font-size-16 mb-1 text-center">4سال عضو مجموعه ما</p>
                        <p class="section__desc font-size-16 mb-0">دبیر دیفرانسیل</p>
                    </div>
