...
//            'mobile.min' => 'فیلد موبایل حداقل باید 11 رقم باشد',
//            'mobile.max' => 'فیلد موبایل حداکثر باید 11 رقم باشد',
            'mobile.iran_phone' => 'شماره موبایل باید برای کشور ایران باشد',
            'phone.required' => 'پر کردن فیلد تلفن ثابت اجباری است',
            'phone.integer' => 'تلفن ثابت باید فقط شامل اعداد باشد',
            'nationalCode.required' => 'پر کردن فیلد کد ملی اجباری است',
            ...
            'password.required' => 'پر کردن فیلد پسورد اجباری است',
