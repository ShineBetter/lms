                    ...
                    <div class="col-lg-10">
                        <div class="menu-wrapper">
                            ...
                            <nav class="main-menu">
                                <ul>
                                    <li>
                                        <a href="dashboard-profile.html#">Home</a>
                                    ...
                                    <li>
                                        <a href="dashboard-profile.html#">courses</a>
                                        <ul class="dropdown-menu-item">
                                    ...
                                    <li>
                                        <a href="dashboard-profile.html#">Student</a>
                                        <ul class="dropdown-menu-item">
                                    ...
                                    <li>
                                        <a href="dashboard-profile.html#">pages</a>
                                        <ul class="dropdown-menu-item">
                                    ...
                                    <li>
                                        <a href="dashboard-profile.html#">blog</a>
                                        <ul class="dropdown-menu-item">
                                                    ...
                                                    <div class="mess-dropdown">
                                                        <div class="mess__title d-flex align-items-center">
                                                            ...
                                                            <div class="content">
                                                                <h4 class="widget-title font-size-16">
                                                                    <a href="dashboard-profile.html#" class="text-white">
                                                                        Alex Smith
                                                                    </a>
                                                                </h4>
                                                        ...
                                                        <div class="mess__body">
                                                            <ul class="list-items">
                                                                ...
                                                                <li class="mb-0">
                                                                    <a href="dashboard-profile.html#" class="d-block">
                                ...
                                <div class="section-tab section-tab-2">
                                    <ul class="nav nav-tabs" role="tablist">
                                        <li role="presentation">
                                            <a href="dashboard-profile.html#notification-home" role="tab" data-toggle="tab" class="active" aria-selected="true">
                                                Notifications
                                            </a>
                                        </li>
                                        <li role="presentation">
                                            <a href="dashboard-profile.html#message-home" role="tab" data-toggle="tab" aria-selected="false">
                                                Messages
                                            </a>
                                        </li>
                                        <li role="presentation">
                                            <a href="dashboard-profile.html#account-home" role="tab" data-toggle="tab" aria-selected="false">
                                                Account
                                            </a>
                                        </li>
                                    </ul>
        ...
        <div class="dashboard-nav-container">
            ...
            <div class="side-menu-wrap">
                <ul class="side-menu-ul">
                    <li class="sidenav__item"><a href="dashboard.html"><i class="la la-dashboard"></i> Dashboard</a></li>
                    <li class="sidenav__item page-active"><a href="dashboard-profile.html"><i class="la la-user"></i>My Profile</a></li>
                ...
                <div class="col-lg-12">
                    <div class="breadcrumb-content dashboard-bread-content d-flex align-items-center justify-content-between">
                        ...
                        <div class="upload-btn-box">
                            <form action="dashboard-profile.html#" method="post" enctype="multipart/form-data">
