    ...
    <section class="container" style="padding: 50px" dir="rtl">
                ...
                <tr style="text-align: justify">
                    ...
                    @if(\Illuminate\Support\Facades\Gate::check('Admin') || \Illuminate\Support\Facades\Gate::check('Teacher'))
                        <td style="text-align: center">
                            ...
                            <a href="{{route('userLessons.edit',['lesson_id' => $item->id, 'teacher_id' => $teacher_id])}}"><input
        ...
        @if(\Illuminate\Support\Facades\Gate::check('Admin') || \Illuminate\Support\Facades\Gate::check('Teacher'))
            <section class="form-group">
                <td style="text-align: center"><a href="{{route('userLessons.create',$teacher_id)}}"><input
