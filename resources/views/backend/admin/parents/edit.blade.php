...
@section('main.content')
    <section dir="rtl">
        ...
        <section class="container" style="padding: 50px" dir="rtl">
            ...
            {{ Form::model($parents,['route' => ['parent.update',$parents->id], 'method' => 'put','files'=>true])}}
            <section class="form-group">
                ...
                {!! Form::text('email', $parents->email, ['class' => 'form-control']) !!}
            ...
            <section class="form-group">
                <a href="{{route('parent.index')}}"><input type="button" class="form-control btn btn-success"
