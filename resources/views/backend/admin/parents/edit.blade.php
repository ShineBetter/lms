                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6 col-sm-6">
                                            <div class="input-box">
                                                ...
                                                <div class="form-group">
                                                    {!! Form::text('name', $data->profile->name, ['class' => 'form-control','placeholder' => 'نام']) !!}
                                        ...
                                        <div class="col-lg-6 col-sm-6">
                                            <div class="input-box">
                                                ...
                                                <span class="primary-color-2 ml-1">*</span>
                                                <div class="form-group">
                                                    {!! Form::text('lastName', $data->profile->lastName, ['class' => 'form-control','placeholder' => 'نام خانوادگی']) !!}
                                                    <span class="la la-file-text-o input-icon"></span>
                                                </div>
                                            </div>
                                        </div><!-- end col-lg-6 -->
                                        <div class="col-lg-6 col-sm-6">
                                            <div class="input-box">
                                                ...
                                                <span class="primary-color-2 ml-1">*</span>
                                                <div class="form-group">
                                                    {!! Form::text('mobile', $data->profile->mobile, ['class' => 'form-control','placeholder' => 'موبایل']) !!}
                                                    <span class="la la-file-text-o input-icon"></span>
                                                </div>
                                            </div>
                                        </div><!-- end col-lg-6 -->
                                        <div class="col-lg-6 col-sm-6">
                                            <div class="input-box">
                                                ...
                                                <span class="primary-color-2 ml-1">*</span>
                                                <div class="form-group">
                                                    {!! Form::text('phone', $data->profile->phone, ['class' => 'form-control','placeholder' => 'تلفن ثابت']) !!}
                                                    <span class="la la-file-text-o input-icon"></span>
                                                </div>
                                            </div>
                                        </div><!-- end col-lg-6 -->
                                        <div class="col-lg-6 col-sm-6">
                                            <div class="input-box">
                                                ...
                                                <span class="primary-color-2 ml-1">*</span>
                                                <div class="form-group">
                                                    {!! Form::text('nationalNumber', $data->profile->nationalNumber, ['class' => 'form-control','placeholder' => 'کد ملی']) !!}
                                                    <span class="la la-file-text-o input-icon"></span>
                                                </div>
                                            </div>
                                        </div><!-- end col-lg-6 -->
                                        ...
                                        <div class="col-lg-6 col-sm-6">
                                            <div class="input-box">
                                                ...
                                                <span class="primary-color-2 ml-1">*</span>
                                                <div class="form-group">
                                                    {!! Form::email('email', $data->email, ['class' => 'form-control','placeholder' => 'ایمیل']) !!}
                                                    <span class="la la-file-text-o input-icon"></span>
                                                </div>
                                            </div>
                                        </div><!-- end col-lg-6 -->
                                        <div class="col-lg-6 col-sm-6">
                                            <div class="input-box">
                                                ...
                                                <span class="primary-color-2 ml-1">*</span>
                                                <div class="form-group">
                                                    {!! Form::date('date_of_birth', $data->profile->data_of_birth,['class' => 'form-control','placeholder' => 'تاریخ تولد']) !!}
                                                    <span class="la la-file-text-o input-icon"></span>
                                                </div>
                                            </div>
                                        </div><!-- end col-lg-6 -->
                                        ...
                                        <div class="col-lg-12 col-sm-12">
                                            <div class="input-box">
                                                ...
                                                <span class="primary-color-2 ml-1">*</span>
                                                <div class="form-group">
                                                    {!! Form::textarea('address', $data->profile->address, ['class' => 'form-control','placeholder' => 'آدرس']) !!}
                                                    <span class="la la-file-text-o input-icon"></span>
                                                </div>
                                            </div>
                                        </div><!-- end col-lg-6 -->
