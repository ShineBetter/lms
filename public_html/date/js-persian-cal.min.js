/*
 ...
 @author Amir Masoud Irani( MDTB )
 MDTBct@gmail.com
 http://MDTB.ir/weblog
*/
if("undefined"===typeof MDTB)var MDTB={};
...
MDTB.persianCalendar.prototype.createDateTable=function(b,a,c){var d=cE("table"),e,g,f,h,k,j;g=this.getOption("defaultDate");j=new Date;f=gregorian_to_jd(j.getFullYear(),j.getMonth()+1,j.getDate());j=jd_to_persian(f);(a=isPersianDate(a))?a=persian_to_jd(a[0],a[1],a[2]):g?(a=persian_to_jd(g[0],g[1],g[2]),c=g.join("/")):a=f;c=isPersianDate(c);a=jd_to_persian(a);var l=Math.floor(persian_to_jd(a[0],a[1],1)+3)%7;e=d.insertRow(-1);g=e.insertCell(-1);g.className="pickerHead";g.colSpan=7;e=cE("div");e.className=
