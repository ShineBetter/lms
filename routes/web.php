...
Route::get('/userLessons/create','userLessonsController@create')->middleware('auth')->name('userLessons.create');
Route::delete('/userLessons/delete/{lesson_id}/{teacher_id}','userLessonsController@destroy')->middleware('auth')->name('userLessons.destroy');
Route::put('/userLessons/{lesson_id}/{teacher_id}','userLessonsController@update')->middleware('auth')->name('userLessons.update');
Route::get('/userLessons/{userLesson}','userLessonsController@show')->middleware('auth')->name('userLessons.show');
Route::get('/userLessons/{lesson_id}/{teacher_id}/edit','userLessonsController@edit')->middleware('auth')->name('userLessons.edit');
