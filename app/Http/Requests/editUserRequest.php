...
class editUserRequest extends FormRequest
{
    ...
    public function messages()
    {
        return [
            ...
            'lastName.min' => ' نام خانوادگی باید بیش از 2 حرف داشته باشد',
            'lastName.string' => 'نام خانوادگی باید از نوع رشته ای باشد',
            'lastName.alpha' => 'نام خانوادگی باید فقط شامل حروف باشد',
