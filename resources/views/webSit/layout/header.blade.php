...
{{--                                <li><a href="home-rtl.html#"><i class="fab fa-linkedin"></i></a></li>--}}
                                ...
                                <ul>
                                    <li>
                                        ...
                                        <ul class="cart-dropdown-menu">
                                            ...
                                            <li>
                                                <p class="cart-total">قیمت کل: 140000<span class="before-price">130000</span></p>
                                            </li>
                                            <li>
                                                <a class="theme-btn w-100 text-center" href="shopping-cart.html">برو به سبد خرید</a>
                                            </li>
                                        </ul>
                                    </li>
                                </ul>
                        ...
                        <div class="header-right-info">
                            <ul class="header-action-list">
                                ...
                                <li>یا</li>
                                <li><a href="/sign-up">ثبت نام</a></li>
                            </ul>
                        </div><!-- end header-right-info -->
                    </div><!-- end header-widget -->
                </div><!-- end col-lg-6 -->
