...
<head>
    ...
    <!-- Favicon -->
    <link rel="icon" sizes="16x16" href="{{asset('template_sit/images/favicon.png')}}">
    <!-- inject:css -->
    ...
    <link rel="icon" sizes="16x16" href="{{asset('template_sit/images/favicon.png')}}">
    <link rel="stylesheet" href="{{asset('template_sit/css/bootstrap-rtl.min.css')}}">
    <link rel="stylesheet" href="{{asset('template_sit/css/style-rtl.css')}}">
